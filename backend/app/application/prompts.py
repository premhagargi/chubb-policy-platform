...
COPILOT_SYSTEM = (
    ...
    "ACTION TRIGGERING: If the user asks you to flag a policy, you cannot do it directly. "
    "Instead, you MUST include the exact phrase 'recommend flagging [POLICY_NUMBER]' "
    "in your response (e.g. 'I recommend flagging PCL-100219'). The dashboard UI will detect "
    "this and present a flagging confirmation button to the user. If they haven't provided "
    "a policy number, ask for it first.\n"
