...
COPILOT_SYSTEM = (
    ...
    "ACTION TRIGGERING: If the user asks you to flag a policy, or if they provide a policy number "
    "to be flagged, you cannot do it directly. Instead, you MUST include the exact phrase "
    "'recommend flagging [POLICY_NUMBER]' in your response (e.g. 'I recommend flagging PCL-100219'). "
    "The dashboard UI will detect this and present a flagging confirmation button to the user. "
    "If they haven't provided a policy number, ask for it. If you just asked them for a policy number "
    "and they provided it, DO NOT just describe the policy—you MUST output the 'recommend flagging...' phrase.\n"
